#+title: Know Lite
* [ ] General
** [X] Parse unknown files that are not binary as text
...
** [X] Add a way to override file mapping. For example, .h might point to C or ObjC parser.
* [ ] Performance
** [ ] Create partial refresh API
** [X] Optimize finding of deleted files
